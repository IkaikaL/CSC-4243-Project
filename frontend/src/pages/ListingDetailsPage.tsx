...
const testDescription = {
	description:
		"in GREAT Shape , never been in the water. Christmas Gift that has been stored since getting. 11-1/2 feet long",
	publishDate: "10/23/2022",
};
const seller = {
	username: "NotARobot",
	profileImagePath:
		"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.jHuJyHBQHuvP9BaqeSEdYAHaFg%26pid%3DApi&f=1&ipt=81fef1be5a99d7a59d8923a01c891943774666ff4c4519667b31f76f65442703&ipo=images",
};
			...
			>
				...
				>
					...
					<Grid
						...
						direction='row'
						alignItems='center'
						sx={{ width: "1000px", paddingTop: "20px", color: "white" }}
					>
						<Grid item sx={{ width: "69%" }}>
							<ListingTitleGallery
								listingTitle={title}
								listingImagePaths={imgPaths}
							/>
						</Grid>
